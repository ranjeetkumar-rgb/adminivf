...
(function($) {
    ...
    function initLeftMenuCollapse() {
        ...
        $(window).on('load', function () {
            let savedSidebarSize = localStorage.getItem('sidebar-size');
            ...
            // Optional: Update radio if topbar is light
            if (document.body.getAttribute("data-topbar") === "light") {
                updateRadio('topbar-color-light');
            }
    
            // Optional: Weather toggle
