                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index" class="d-block auth-logo">
                                    ...
                                    <img src="{{ asset('storage/' . $globalSettings->site_logo) }}" alt="{{ $globalSettings->site_name ?? 'Logo' }}" height="28">
                                @else
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Reset Password with {{ $globalSettings->site_name ?? 'IndiaIVF' }}.</p>
                                </div>
