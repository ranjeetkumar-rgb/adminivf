                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index" class="d-block auth-logo">
                                    <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">IndiaIVF</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15">Thank you for using <span class="fw-semibold text-dark">IndiaIVF</span></p>
                                        <div class="mt-4">
