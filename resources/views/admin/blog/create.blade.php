                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5" placeholder="Enter blog content">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description1') is-invalid @enderror" id="description1" name="description1" rows="5" placeholder="Enter blog content">{{ old('description1') }}</textarea>
                                    @error('description1')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description2') is-invalid @enderror" id="description2" name="description2" rows="5" placeholder="Enter blog content">{{ old('description2') }}</textarea>
                                    @error('description2')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description3') is-invalid @enderror" id="description3" name="description3" rows="5" placeholder="Enter blog content">{{ old('description3') }}</textarea>
                                    @error('description3')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description4') is-invalid @enderror" id="description4" name="description4" rows="5" placeholder="Enter blog content">{{ old('description4') }}</textarea>
                                    @error('description4')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description5') is-invalid @enderror" id="description5" name="description5" rows="5" placeholder="Enter blog content">{{ old('description5') }}</textarea>
                                    @error('description5')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_tests_content') is-invalid @enderror" id="key_tests_content" name="key_tests_content" rows="5" placeholder="Enter blog content">{{ old('key_tests_content') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_tests_section_1') is-invalid @enderror" id="key_tests_section_1" name="key_tests_section_1" rows="5" placeholder="Enter blog content">{{ old('key_tests_section_1') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_tests_section_2') is-invalid @enderror" id="key_tests_section_2" name="key_tests_section_2" rows="5" placeholder="Enter blog content">{{ old('key_tests_section_2') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_tests_section_3') is-invalid @enderror" id="key_tests_section_3" name="key_tests_section_3" rows="5" placeholder="Enter blog content">{{ old('key_tests_section_3') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('key_tests_section_4') is-invalid @enderror" id="key_tests_section_4" name="key_tests_section_4" rows="5" placeholder="Enter blog content">{{ old('key_tests_section_4') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('male_factor_and_key_male_fertility') is-invalid @enderror" id="male_factor_and_key_male_fertility" name="male_factor_and_key_male_fertility" rows="5" placeholder="Enter blog content">{{ old('male_factor_and_key_male_fertility') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('icsi') is-invalid @enderror" id="icsi" name="icsi" rows="5" placeholder="Enter blog content">{{ old('icsi') }}</textarea>
                                    @error('icsi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('video_url') is-invalid @enderror" id="video_url" name="video_url" placeholder="https://www.youtube.com/watch?v=VIDEO_ID" value="{{ old('video_url') }}">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lifestyle') is-invalid @enderror" id="lifestyle" name="lifestyle" rows="5" placeholder="Enter blog content">{{ old('lifestyle') }}</textarea>
                                    @error('lifestyle')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('nutrition') is-invalid @enderror" id="nutrition" name="nutrition" rows="5" placeholder="Enter blog content">{{ old('nutrition') }}</textarea>
                                    @error('nutrition')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('exercise') is-invalid @enderror" id="exercise" name="exercise" rows="5" placeholder="Enter blog content">{{ old('exercise') }}</textarea>
                                    @error('exercise')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('avoid') is-invalid @enderror" id="avoid" name="avoid" rows="5" placeholder="Enter blog content">{{ old('avoid') }}</textarea>
                                    @error('avoid')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('clinic') is-invalid @enderror" id="clinic" name="clinic" rows="5" placeholder="Enter blog content">{{ old('clinic') }}</textarea>
                                    @error('clinic')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('laboratory_standards') is-invalid @enderror" id="laboratory_standards" name="laboratory_standards" rows="5" placeholder="Enter blog content">{{ old('laboratory_standards') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('experienced_team') is-invalid @enderror" id="experienced_team" name="experienced_team" rows="5" placeholder="Enter blog content">{{ old('experienced_team') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('transparent_success_rates') is-invalid @enderror" id="transparent_success_rates" name="transparent_success_rates" rows="5" placeholder="Enter blog content">{{ old('transparent_success_rates') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('dr_review') is-invalid @enderror" id="dr_review" name="dr_review" rows="5" placeholder="Enter blog content">{{ old('dr_review') }}</textarea>
                                    @error('dr_review')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('previous_attempts') is-invalid @enderror" id="previous_attempts" name="previous_attempts" rows="5" placeholder="Enter blog content">{{ old('previous_attempts') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('success_after_attempts') is-invalid @enderror" id="success_after_attempts" name="success_after_attempts" rows="5" placeholder="Enter blog content">{{ old('success_after_attempts') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('emotional_support') is-invalid @enderror" id="emotional_support" name="emotional_support" rows="5" placeholder="Enter blog content">{{ old('emotional_support') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('partner_support') is-invalid @enderror" id="partner_support" name="partner_support" rows="5" placeholder="Enter blog content">{{ old('partner_support') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('support_groups') is-invalid @enderror" id="support_groups" name="support_groups" rows="5" placeholder="Enter blog content">{{ old('support_groups') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('professinal_counselling') is-invalid @enderror" id="professinal_counselling" name="professinal_counselling" rows="5" placeholder="Enter blog content">{{ old('professinal_counselling') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('personalized_treatment') is-invalid @enderror" id="personalized_treatment" name="personalized_treatment" rows="5" placeholder="Enter blog content">{{ old('personalized_treatment') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('india_advantage') is-invalid @enderror" id="india_advantage" name="india_advantage" rows="5" placeholder="Enter blog content">{{ old('india_advantage') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('conclusion') is-invalid @enderror" id="conclusion" name="conclusion" rows="5" placeholder="Enter blog content">{{ old('conclusion') }}</textarea>
                                    @error('conclusion')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('your_journey') is-invalid @enderror" id="your_journey" name="your_journey" rows="5" placeholder="Enter blog content">{{ old('your_journey') }}</textarea>
                                    @error('your_journey')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('user_write_and_tag_create') is-invalid @enderror" id="user_write_and_tag_create" name="user_write_and_tag_create" rows="5" placeholder="Enter blog content">{{ old('user_write_and_tag_create') }}</textarea>
