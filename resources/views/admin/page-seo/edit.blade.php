    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Edit Page SEO - {{ ucfirst($pageSeo->page_name) }}</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.page-seo.update', $pageSeo->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="page_name" id="page_name" class="form-select @error('page_name') is-invalid @enderror" required>
                                                @foreach($pages as $key => $value)
                                                    <option value="{{ $key }}" {{ old('page_name', $pageSeo->page_name) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="page_title" id="page_title" 
                                               ...
                                               value="{{ old('page_title', $pageSeo->page_title) }}" required maxlength="255">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="meta_description" id="meta_description" rows="3" 
                                                  ...
                                                  required maxlength="500">{{ old('meta_description', $pageSeo->meta_description) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords" 
                                               ...
                                               value="{{ old('meta_keywords', $pageSeo->meta_keywords) }}" maxlength="500">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="focus_keyword" id="focus_keyword" 
                                               ...
                                               value="{{ old('focus_keyword', $pageSeo->focus_keyword) }}" maxlength="100">
                                        @error('focus_keyword')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" name="index_follow" id="index_follow" 
                                                   ...
                                                   {{ old('index_follow', $pageSeo->index_follow) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="og_title" id="og_title" 
                                               ...
                                               value="{{ old('og_title', $pageSeo->og_title) }}" maxlength="255">
                                        @error('og_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="og_description" id="og_description" rows="3" 
                                                  class="form-control @error('og_description') is-invalid @enderror">{{ old('og_description', $pageSeo->og_description) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($pageSeo->og_image)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $pageSeo->og_image) }}" 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="og_type" id="og_type" class="form-select @error('og_type') is-invalid @enderror">
                                            <option value="website" {{ old('og_type', $pageSeo->og_type) == 'website' ? 'selected' : '' }}>Website</option>
                                            <option value="article" {{ old('og_type', $pageSeo->og_type) == 'article' ? 'selected' : '' }}>Article</option>
                                            <option value="product" {{ old('og_type', $pageSeo->og_type) == 'product' ? 'selected' : '' }}>Product</option>
                                            <option value="profile" {{ old('og_type', $pageSeo->og_type) == 'profile' ? 'selected' : '' }}>Profile</option>
                                        </select>
                                        @error('og_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="twitter_title" id="twitter_title" 
                                               ...
                                               value="{{ old('twitter_title', $pageSeo->twitter_title) }}" maxlength="255">
                                        @error('twitter_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="twitter_description" id="twitter_description" rows="3" 
                                                  class="form-control @error('twitter_description') is-invalid @enderror">{{ old('twitter_description', $pageSeo->twitter_description) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($pageSeo->twitter_image)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $pageSeo->twitter_image) }}" 
                                                     alt="Current Twitter Image" class="img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="twitter_card" id="twitter_card" class="form-select @error('twitter_card') is-invalid @enderror">
                                            <option value="summary_large_image" {{ old('twitter_card', $pageSeo->twitter_card) == 'summary_large_image' ? 'selected' : '' }}>Summary Large Image</option>
                                            <option value="summary" {{ old('twitter_card', $pageSeo->twitter_card) == 'summary' ? 'selected' : '' }}>Summary</option>
                                            <option value="app" {{ old('twitter_card', $pageSeo->twitter_card) == 'app' ? 'selected' : '' }}>App</option>
                                        </select>
                                        @error('twitter_card')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="twitter_site" id="twitter_site" 
                                               ...
                                               value="{{ old('twitter_site', $pageSeo->twitter_site) }}" maxlength="100">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="twitter_creator" id="twitter_creator" 
                                               ...
                                               value="{{ old('twitter_creator', $pageSeo->twitter_creator) }}" maxlength="100">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="author" id="author" 
                                               ...
                                               value="{{ old('author', $pageSeo->author) }}" maxlength="100">
                                        @error('author')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="robots" id="robots" 
                                               ...
                                               value="{{ old('robots', $pageSeo->robots) }}" maxlength="100">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" name="is_active" id="is_active" 
                                                   class="form-check-input" value="1" 
                                                   {{ old('is_active', $pageSeo->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update Page SEO
                                    </button>
                                    <a href="{{ route('admin.page-seo.index') }}" class="btn btn-secondary">
                                        <i class="fas fa-times"></i> Cancel
                                    </a>
