        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Edit Schema</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Schema: {{ $schema->name }}</h4>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form action="{{ route('admin.schema.update', $schema->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                            ...
                                            @foreach($schemaTypes as $key => $value)
                                                <option value="{{ $key }}" {{ old('type', $schema->type) == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('content_type') is-invalid @enderror" id="content_type" name="content_type">
                                            ...
                                            @foreach($contentTypes as $key => $value)
                                                <option value="{{ $key }}" {{ old('content_type', $schema->content_type) == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('content_id') is-invalid @enderror" 
                                               ...
                                               value="{{ old('content_id', $schema->content_id) }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description for this schema">{{ old('description', $schema->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('schema_data') is-invalid @enderror" 
                                          ...
                                          placeholder='{"@context": "https://schema.org", "@type": "Article", "headline": "Your Title"}'>{{ old('schema_data', $schema->getFormattedSchema()) }}</textarea>
                                @error('schema_data')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                           {{ old('is_active', $schema->is_active) ? 'checked' : '' }}>
