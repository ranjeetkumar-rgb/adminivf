        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center py-4 py-sm-5">
                    <div class="mb-5">
                        <a href="index">
                            <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="30" class="me-1"><span class="logo-txt text-white font-size-22">IndiaIVF</span>
                        </a>
                    </div>
                    <h3 class="text-white mt-5">Let's get started with IndiaIVF</h3>
