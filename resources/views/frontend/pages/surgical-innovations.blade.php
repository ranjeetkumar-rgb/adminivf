...
<section class="relative bg-gradient-to-b from-pink-50 via-white to-blue-50 py-12 overflow-hidden">
        <div
            ...
            <div class="md:w-1/2">
                <h1 class="text-5xl font-bold text-gray-800 leading-tight mb-4"><span class="text-brand-pink">Surgical
                        Innovations and Fertility Care</span></h1>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Stem Cell Research in Reproductive Medicine
            </h2>
    ...
    <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
        <div class="relative container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">How Advanced Research will shape <span
                    class="text-pink-600">Tomorrow's IVF?</span></h2>
