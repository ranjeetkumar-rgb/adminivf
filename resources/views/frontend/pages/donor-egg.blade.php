...
@section('content')
    <section class="relative bg-gradient-to-b from-pink-50 via-white to-blue-50 py-12 overflow-hidden">
        <div
            ...
            <div class="md:w-1/2">
                <h1 class="text-5xl font-bold text-gray-800 leading-tight mb-4"><span class="text-brand-pink">Donor
                        Egg</span> Program</h1>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Who it is recommended for?</h2>
    ...
    <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
        <div class="relative container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Donor <span class="text-pink-600">Selection
                    &amp; Matching </span>Process</h2>
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <i class="fa-solid fa-vial-circle-check"></i></div>
                    <div class="mt-6 max-w-xs">
                ...
                <div
                    ...
                    <div
                        ...
                        <i class="fa-solid fa-x-ray"></i></div>
                    <div class="mt-6 max-w-xs">
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            ...
                            <i class="fa-solid fa-heart-pulse text-2xl"></i></div>
                ...
                <div
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            class="w-16 h-16 flex items-center justify-center rounded-full bg-brand-blue text-white shadow-xl mb-6 group-hover:scale-110 transition-transform duration-300">
                            <i class="fa-solid fa-flask text-2xl"></i></div>
