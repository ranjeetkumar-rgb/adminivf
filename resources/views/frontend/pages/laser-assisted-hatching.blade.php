...
@section('content')
    <section class="relative bg-gradient-to-b from-pink-50 via-white to-blue-50 py-12 overflow-hidden">
        <div
            ...
            <div class="md:w-1/2">
                <h1 class="text-5xl font-bold text-gray-800 leading-tight mb-4"><span class="text-brand-pink">Laser
                        Assisted Hatching</span></h1>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why it is needed?</h2>
    ...
    <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
        <div class="relative container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">How Laser Assisted Hatching <span
