...
@section('content')
    <section class="relative bg-gradient-to-b from-pink-50 via-white to-blue-50 py-12 overflow-hidden">
         <div
            ...
            <div class="md:w-1/2">
               <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-4">Difficulty <span
                  class="text-brand-pink">Conceiving</span></h1>
    ...
    <section class="py-12 bg-white">
         <div class="container mx-auto px-6 text-center">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4">Common Causes of Difficulty Conceiving</h2>
            ...
            <div class="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-hide">
               <div
                  class="flex-shrink-0 w-80 md:w-auto bg-gradient-to-b from-pink-50 to-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition snap-start">
                  <img src="https://images.pexels.com/photos/7653670/pexels-photo-7653670.jpeg"
                     alt="Hormonal Imbalance" class="w-24 h-24 mx-auto rounded-full mb-4 object-cover shadow-md">
                  <h3 class="text-xl font-semibold text-gray-800 mb-3">Hormonal Imbalances</h3>
                  <p class="text-gray-600">Irregular hormone levels can disrupt ovulation or sperm production,
               ...
               <div
                  ...
                  <img src="https://images.pexels.com/photos/5982466/pexels-photo-5982466.jpeg"
                     ...
                     class="w-24 h-24 mx-auto rounded-full mb-4 object-cover shadow-md">
                  <h3 class="text-xl font-semibold text-gray-800 mb-3">Blocked Fallopian Tubes</h3>
                  <p class="text-gray-600">Tubal blockages can prevent the egg and sperm from meeting. Advanced
               ...
               <div
                  ...
                  <img src="https://images.pexels.com/photos/11219937/pexels-photo-11219937.jpeg"
                     ...
                     class="w-24 h-24 mx-auto rounded-full mb-4 object-cover shadow-md">
                  <h3 class="text-xl font-semibold text-gray-800 mb-3">Male Factor Infertility</h3>
                  <p class="text-gray-600">Issues with sperm count, movement, or structure are common and treatable.
    ...
    <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
         <div class="relative container mx-auto px-6 text-center">
            ...
            <div
               class="relative flex md:flex-row flex-nowrap md:justify-between items-start md:items-center space-x-4 md:space-x-6 overflow-x-auto md:overflow-visible snap-x snap-mandatory scrollbar-hide pb-4">
               ...
               <div
                  ...
                  <div
                     class="w-24 h-24 flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-rose-400 text-white text-4xl shadow-xl z-10 relative group-hover:scale-110 transition-transform duration-300">
                     <i class="fa-solid fa-flask"></i>
                  </div>
                  <div class="mt-6 max-w-xs">
                     <h3 class="text-xl font-semibold text-gray-800 mb-2">Hormone Tests</h3>
                     <p class="text-gray-600">Checks levels of FSH, LH, and AMH to assess ovarian health and
                        ovulation.
                     </p>
                  </div>
               </div>
               <div
                  class="flex-shrink-0 snap-start flex flex-col items-center text-center min-w-[260px] md:min-w-0 md:w-1/4 group">
                  <div
                     class="w-24 h-24 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-4xl shadow-xl z-10 relative group-hover:scale-110 transition-transform duration-300">
                     <i class="fa-solid fa-vial-circle-check"></i>
                  </div>
                  <div class="mt-6 max-w-xs">
                     <h3 class="text-xl font-semibold text-gray-800 mb-2">Semen Analysis</h3>
                     <p class="text-gray-600">Evaluates sperm count, shape, and motility — key to identifying male
                        factors.
                     </p>
                  </div>
               </div>
               <div
                  class="flex-shrink-0 snap-start flex flex-col items-center text-center min-w-[260px] md:min-w-0 md:w-1/4 group">
                  <div
                     class="w-24 h-24 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white text-4xl shadow-xl z-10 relative group-hover:scale-110 transition-transform duration-300">
                     <i class="fa-solid fa-x-ray"></i>
                  </div>
                  <div class="mt-6 max-w-xs">
                     <h3 class="text-xl font-semibold text-gray-800 mb-2">Imaging</h3>
                     <p class="text-gray-600">Uses ultrasound and HSG scans to visualize uterus and fallopian tubes.
                     </p>
                  </div>
               </div>
               <div
                  class="flex-shrink-0 snap-start flex flex-col items-center text-center min-w-[260px] md:min-w-0 md:w-1/4 group">
                  <div
                     class="w-24 h-24 flex items-center justify-center rounded-full bg-gradient-to-r from-teal-500 to-blue-500 text-white text-4xl shadow-xl z-10 relative group-hover:scale-110 transition-transform duration-300">
                     <i class="fa-solid fa-dna"></i>
                  </div>
                  <div class="mt-6 max-w-xs">
                     <h3 class="text-xl font-semibold text-gray-800 mb-2">Genetic Testing</h3>
                     <p class="text-gray-600">Identifies chromosomal and hereditary factors affecting conception.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div
               ...
               <div
                  ...
                  <div class="flex flex-col items-center text-center">
                     <div
                        class="w-16 h-16 flex items-center justify-center rounded-full bg-brand-blue text-white shadow-xl mb-6 group-hover:scale-110 transition-transform duration-300">
    ...
    <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
         ...
         <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-5 animate-fadeInUp delay-300"><a
               ...
               class="bg-brand-blue text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base md:text-lg shadow-lg hover:bg-brand-pink hover:scale-105 transition-all duration-300">Book
               a Consultation </a><a href="#contact"
                  class="border-2 border-[#20417e] text-[#20417e] px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base md:text-lg hover:bg-[#20417e] hover:text-white transition-all duration-300">Call
               Now</a>
            </div>
         </div>
    </section>
