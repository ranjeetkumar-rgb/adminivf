...
@section('content')
      <section id="hero-section"
         class="relative bg-gradient-to-br from-[#20417e] via-[#2f4c8a] to-[#778aaf] text-white overflow-hidden py-8 md:py-12">
         <div
            class="container mx-auto px-4 sm:px-6 lg:px-20 grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center relative z-10 flex flex-col-reverse lg:grid">
            <div class="space-y-4 md:space-y-6 animate-fadeInUp text-center lg:text-left w-full">
               <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">Advanced Fertility Techniques for <span
                  class="text-pink-200">Higher IVF Success</span><br class="hidden md:block"></h1>
               <p class="text-base sm:text-lg md:text-xl text-blue-100 leading-relaxed">At India IVF, we use cutting-edge
                  technologies and precision fertility methods to maximize your chances of conception — safely and
                  ethically.
               </p>
               <button
                  class="mt-4 inline-block bg-white text-[#20417e] font-semibold px-6 py-2.5 sm:px-8 sm:py-3 rounded-full shadow-lg hover:bg-pink-100 hover:scale-105 transition-all duration-300 ease-in-out text-sm sm:text-base">Book
               a Consultation</button>
            </div>
            <div class="relative group animate-fadeInLeft w-full">
               <div
                  class="absolute -inset-2 md:-inset-4 bg-pink-200/20 rounded-2xl md:rounded-3xl blur-xl opacity-60 group-hover:opacity-90 transition">
               </div>
               <video autoplay="" muted="" loop="" playsinline=""
                  class="relative rounded-2xl md:rounded-3xl shadow-2xl border-2 md:border-4 border-white/30 group-hover:scale-105 transition duration-700 ease-out w-full h-auto max-h-[300px] md:max-h-[400px] lg:max-h-none object-cover">
                  <source src="videos/hero.mp4" type="video/mp4">
                  Your browser does not support the video tag.
               </video>
               <div
                  class="absolute inset-0 bg-black/20 rounded-2xl md:rounded-3xl group-hover:bg-black/10 transition duration-300 ease-in-out">
               </div>
            </div>
         </div>
      </section>
      ...
      <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
         <div class="container mx-auto px-6 lg:px-12 relative">
            ...
            <div class="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 md:mb-10 text-xs sm:text-sm"><button id="btn-ivf"
               onclick='showTechnique("ivf")'
               class="flex-shrink-0 px-4 py-2 sm:px-6 sm:py-3 rounded-full border-2 border-pink-400 bg-white text-gray-700 font-semibold shadow-sm hover:bg-pink-100 hover:text-pink-700 transition-all duration-300 focus:outline-none text-center">Embryo
               Development &amp; Transfer Techniques</button> <button id="btn-icsi" onclick='showTechnique("icsi")'
                  class="flex-shrink-0 px-4 py-2 sm:px-6 sm:py-3 rounded-full border-2 border-pink-400 bg-white text-gray-700 font-semibold shadow-sm hover:bg-pink-100 hover:text-pink-700 transition-all duration-300 focus:outline-none text-center">Laboratory
               &amp; Safety Innovations</button> <button id="btn-iui" onclick='showTechnique("iui")'
                  class="flex-shrink-0 px-4 py-2 sm:px-6 sm:py-3 rounded-full border-2 border-pink-400 bg-white text-gray-700 font-semibold shadow-sm hover:bg-pink-100 hover:text-pink-700 transition-all duration-300 focus:outline-none text-center">Male
               Surgical Procedures</button> <button id="btn-genetic" onclick='showTechnique("genetic")'
                  class="flex-shrink-0 px-4 py-2 sm:px-6 sm:py-3 rounded-full border-2 border-pink-400 bg-white text-gray-700 font-semibold shadow-sm hover:bg-pink-100 hover:text-pink-700 transition-all duration-300 focus:outline-none text-center">Emerging
               Technologies</button>
            </div>
            <div id="ivf"
      ...
      <section class="relative py-12 bg-white overflow-hidden">
         <div class="container mx-auto px-6 lg:px-12">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8 md:mb-12 px-4">How <span
      ...
      <section class="relative py-12 bg-gradient-to-b from-pink-50 via-white to-blue-50 overflow-hidden">
         ...
         <div class="container mx-auto px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center gap-12">
            <div class="lg:w-1/2 text-center lg:text-left">
               <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-6 leading-tight"><span
                  class="text-brand-pink">Precision</span> Meets <span class="text-brand-blue">Compassion</span>
                  in Fertility Treatment
               </h2>
               <p class="text-gray-600 text-base sm:text-lg leading-relaxed mb-6 md:mb-8">Our advanced fertility technologies are designed
               ...
               <div class="flex flex-wrap justify-center lg:justify-start gap-3 md:gap-4"><a href="#"
                  class="px-6 py-2.5 sm:px-8 sm:py-3 rounded-full bg-brand-blue text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 text-sm sm:text-base">Learn
                  More </a><a href="#"
                     class="px-6 py-2.5 sm:px-8 sm:py-3 rounded-full border-2 border-pink-400 text-pink-600 font-semibold hover:bg-pink-100 transition-all duration-300 text-sm sm:text-base">Book
                  Consultation</a>
               </div>
            </div>
            <div class="lg:w-1/2 relative group">
               ...
               <img
                  ...
                  class="relative z-10 rounded-2xl md:rounded-[2.5rem] shadow-2xl object-cover w-full h-[300px] sm:h-[400px] md:h-[480px] transform hover:scale-[1.02] transition-all duration-500">
            </div>
         </div>
      </section>
      <section class="relative bg-white py-12 overflow-hidden">
         <div class="container mx-auto px-6 lg:px-16 relative z-10">
            ...
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-6 leading-tight"><span class="text-brand-pink">Real
      ...
      <section class="relative bg-brand-blue text-white py-6 text-center">
         <div class="container mx-auto px-6">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4">Ready to Take the Next Step?</h2>
            <p class="text-base sm:text-lg mb-4 md:mb-6 max-w-2xl mx-auto px-4">Our fertility specialists are here to listen, guide, and support
               you — with care that's both expert and empathetic.
            </p>
            <button
               class="bg-brand-pink text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-full shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 mb-2 text-sm sm:text-base"><i
      ...
      <section class="relative bg-gradient-to-b from-pink-50 via-white to-blue-50 py-12 overflow-hidden">
         <div class="container mx-auto px-6 lg:px-16 relative z-10">
            <div class="text-center mb-8">
               <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-6 leading-tight">Empowering the <span
            ...
            <div class="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center gap-12">
               ...
               <div class="flex-1 space-y-4 md:space-y-6">
                  <p class="text-gray-700 text-base sm:text-lg leading-relaxed">"Dr. Richika Sahay Shukla is a highly respected IVF
                  ...
                  <p class="text-gray-700 text-base sm:text-lg leading-relaxed">She has trained at premier institutions and worked
      ...
      <section id="learn-fertility"
         ...
         <div class="container mx-auto px-6 lg:px-16 relative z-10">
            <div class="text-center mb-8 max-w-3xl mx-auto">
               <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-800 leading-tight mb-3 md:mb-4">Learn More About <span
                  class="bg-brand-pink bg-clip-text text-transparent">Fertility Health</span></h2>
               <p class="text-gray-600 text-base sm:text-lg">Explore trusted insights and expert guidance on fertility, reproductive
      ...
      <section class="relative py-12 bg-white overflow-hidden">
         <div class="container mx-auto px-6 text-center relative z-10">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 leading-tight mb-4 md:mb-6 px-4">Ready to <span
               class="text-brand-pink">Start Your Fertility Journey?</span></h2>
            <p class="text-gray-600 text-base sm:text-lg max-w-3xl mx-auto mb-8 md:mb-10 animate-fadeInUp delay-150 px-4">Begin your journey with
      ...
      <section
         ...
         <div class="container mx-auto relative z-10 px-6 lg:px-16">
            <div class="lg:w-2/3">
               ...
               <p class="text-blue-100 text-base sm:text-lg mb-8 md:mb-10">Understanding your options is the first step toward hope. Here are some
