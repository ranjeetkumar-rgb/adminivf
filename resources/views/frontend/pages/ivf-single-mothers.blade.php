...
@section('content')
        ...
        <div
            ...
            <div class="md:w-1/2">
                <h1 class="text-5xl font-bold text-gray-800 leading-tight mb-4">IVF for <span
                        class="text-brand-pink">Single Mothers</span></h1>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4"><span class="text-brand-pink">IVF Options
                </span>for Single Mothers</h2>
